...
#     ]
# #     _sql_constraints = [
# #         ('name_ref_uniq', 'unique (name_replace)', 'name_replace must be unique !'),
# #     ]
...
# #     , ('name_replace', operator, name_replace)
#     
#     name_replace = fields.Char(required=True,compute='name_replace_',store=True)
#     @api.model
