...
#             print ("self.picking_type_id.use_create_lots",self.picking_type_id.use_create_lots)
#             print ("not self.picking_type_id.use_existing_lots and self.state != 'done'",not self.picking_type_id.use_existing_lots and self.state != 'done')
